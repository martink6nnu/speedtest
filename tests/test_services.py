...
class TestSpeedService:
    ...
    def test_get_speedtest_results_success(self, speed_service, mock_request_repository, mock_expected_format):
        """Test successful speedtest result processing"""
        mock_request_repository.get_speedtest_results.return_value = mock_expected_format
    ...
    def test_get_speedtest_results_with_different_data(self, speed_service, mock_request_repository):
    ...
    def test_get_speedtest_results_missing_bandwidth_key(self, speed_service, mock_request_repository):
    ...
    def test_get_speedtest_results_missing_server_info(self, speed_service, mock_request_repository):
    ...
    def test_get_speedtest_results_repository_exception(self, speed_service, mock_request_repository):
        """Test handling of repository exceptions"""
        mock_request_repository.get_speedtest_results.side_effect = Exception("Network error")
        
        with pytest.raises(Exception, match="Network error"):
            speed_service.get_speedtest_results()

    def test_get_speedtest_results_zero_values(self, speed_service, mock_request_repository):
